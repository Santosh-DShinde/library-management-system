# Generated by Django 3.2 on 2023-05-23 12:41

import library_app.model.users
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='library_app.roles')),
            ...
            managers=[
                ('objects', library_app.model.users.CustomUserManager()),
            ],
        ),
    ]
